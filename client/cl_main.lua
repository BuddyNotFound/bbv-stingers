...
function Main:PlaceSpike()
    ...
    CreateThread(function()
		...
		if #(GetEntityCoords(CurrentObject) - GetEntityCoords(PlayerPedId())) >= 5 then return Wrapper:Notify(Lang.SpikesCantBePlaced) self:CancelPlacement(CurrentObject) end			
                Wait(100)
